...
/* GTS Root R4 -- for api.anthropic.com (usage endpoint). */
static const unsigned char ca_cert_gts_r4[] =
	"-----BEGIN CERTIFICATE-----\n"
...
/* ISRG Root X1 -- for console.anthropic.com (OAuth token endpoint). */
static const unsigned char ca_cert_isrg_x1[] =
	"-----BEGIN CERTIFICATE-----\n"
