...
README.md's "Something's wrong?" section tells customers to email support the tail of ~/.overwatch/bridge.log
...
_PRIVACY_PROMISE = (
    "README.md's troubleshooting section promises customers that the tail of ~/.overwatch/bridge.log "
