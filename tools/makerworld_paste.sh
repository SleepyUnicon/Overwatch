...
OUT="${1:-$HOME/Downloads/overwatch-makerworld-paste.html}"
...
page = '''<meta charset="utf-8"><title>OVERWATCH - paste into MakerWorld</title>
<style>
 body{background:#fff;color:#111;font:16px/1.55 -apple-system,OverwatchMacSystemFont,"Segoe UI",sans-serif;
...
<div id="note"><b>Select from the line below to the end</b> (click just before "OVERWATCH",
